    ...
    <div>
      ...
      <div className="main_navbar_container flex justify-center">
        <nav className="flex justify-between max-md:px-0  items-center relative  gap-20  max-lg:gap-8 ">
          <div
            className={`right_nav_section list-none flex  text-base font-semibold max-md:flex-col  	text-white  max-md:flex-grow  max-md:absolute max-md:bg-white max-md:text-black max-md:gap-5 max-md:top-10 max-md:h-full  max-md:w-[50%]   max-md:hidden  gap-10 max-lg:gap-5`}
          >
            <Link
          ...
          {isOpen && (
            <>
              <div
                className={`right_nav_section mobile_responsive list-none flex gap-10 text-base font-semibold max-lg:flex-col  	text-white  max-lg:flex-grow max-lg:w-auto  max-md:fixed max-md:bg-white max-md:text-black max-md:gap-0 max-md:h-full  max-md:w-[50%]  md:hidden  overscroll-none	top-0 `}
              >
                ...
                <ul className="p-4 relative  nav_item_child_main group max-md:p-2 flex  items-center justify-center">
                  Airlines    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z" /></svg>
